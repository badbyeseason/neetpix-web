...
export default function PdfCompressClient() {
  ...
  const compress = useCallback(async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = "neetpix-compressed.pdf";
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    ...
                    className={optionBtn(level === "light")}
                  >
                    {t("levelLight")}
                  </button>
                  <button
                    ...
                    className={optionBtn(level === "strong")}
                  >
                    {t("levelStrong")}
                  </button>
                </div>
        ...
        <div className="flex flex-col items-center gap-6 py-10">
          ...
          <div className="w-full max-w-md grid grid-cols-3 gap-3 text-center">
            <div className="rounded-xl border border-border bg-bg-warm p-4">
              <p className="text-xs text-text-secondary">{t("original")}</p>
              <p className="mt-1 text-sm font-semibold text-text">
                {formatFileSize(originalSize)}
              </p>
            </div>
            <div className="rounded-xl border border-border bg-bg-warm p-4">
              <p className="text-xs text-text-secondary">{t("compressed")}</p>
              <p className="mt-1 text-sm font-semibold text-text">
                {formatFileSize(compressedSize)}
              </p>
            </div>
            <div className="rounded-xl border border-teal bg-teal-bg p-4">
              <p className="text-xs text-teal">{t("saved")}</p>
              <p className="mt-1 text-sm font-semibold text-teal">{savedRatio}%</p>
            </div>
          </div>

          <a
            href={downloadUrl}
            download="neetpix-compressed.pdf"
