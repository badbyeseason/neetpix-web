...
export default function PdfDecryptClient() {
  const t = useTranslations("pdfDecrypt");
  ...
  const decrypt = useCallback(async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = "neetpix-decrypted.pdf";
    ...
    <div>
        ...
        >
          ...
          <div className="flex flex-col items-center gap-3">
            <svg className="w-10 h-10 text-text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 11V7a4 4 0 118 0m-4 8v2a2 2 0 11-4 0v-2a2 2 0 114 0z" />
            </svg>
      ...
      {status === "idle" && file && (
        <div className="space-y-6">
          ...
          {/* 未加密提示：不显示密码输入框和按钮 */}
          {isEncrypted === false && (
            <div className="rounded-xl bg-coral/5 border border-coral/20 px-4 py-3 flex items-start gap-3">
              <svg className="w-5 h-5 text-coral flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <p className="text-sm text-coral">{t("errorNotEncrypted")}</p>
            </div>
          )}
              ...
              <div className="flex justify-center">
                ...
                >
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 11V7a4 4 0 118 0m-4 8v2a2 2 0 11-4 0v-2a2 2 0 114 0z" />
                  </svg>
                  {t("decrypt")}
                </button>
              </div>
          ...
          {isEncrypted === null && (
            <div className="flex items-center justify-center gap-3 py-4">
              ...
              <p className="text-sm text-text-secondary">{t("detecting")}</p>
            </div>
          )}
      ...
      {status === "processing" && (
        <div className="flex flex-col items-center justify-center py-20 gap-6">
          ...
          <p className="text-text-secondary font-medium">{t("decrypting")}</p>
        </div>
      )}
      ...
      {status === "done" && (
        <div className="flex flex-col items-center gap-5 py-10">
          ...
          {downloadUrl && (
            <a
              href={downloadUrl}
              download="neetpix-decrypted.pdf"
