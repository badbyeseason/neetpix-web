...
export default function PdfPageNumbersClient() {
  ...
  const applyPageNumbers = useCallback(async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = "neetpix-page-numbers.pdf";
    ...
    <div>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  >
                    {t("positionBottomCenter")}
                  </button>
                  <button
                    type="button"
                    onClick={() => setPosition("left")}
                    className={optionBtn(position === "left")}
                  >
                  ...
                  <button
                    ...
                    className={optionBtn(position === "right")}
                  >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full sm:w-48 rounded-xl border border-border bg-bg-warm px-4 py-3 text-sm text-text focus:outline-none focus:border-teal focus:ring-1 focus:ring-teal"
                />
              </div>

              {/* 格式选择 */}
              <div>
                <p className="mb-2 text-sm font-medium text-text">{t("format")}</p>
                <div className="flex flex-wrap gap-2">
                  <button
                    type="button"
                    onClick={() => setFormat("plain")}
                    className={optionBtn(format === "plain")}
                  >
                    {t("formatPlain")}
                  </button>
                  <button
                    ...
                    className={optionBtn(format === "page")}
                  >
                    {t("formatPage")}
                  </button>
                  <button
                    ...
                    className={optionBtn(format === "pageOf")}
                  >
                    {t("formatPageOf")}
                  </button>
                </div>
      ...
      {status === "done" && downloadUrl && (
        <div className="flex flex-col items-center gap-5 py-10">
          ...
          <a
            href={downloadUrl}
            download="neetpix-page-numbers.pdf"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-teal text-white font-semibold text-sm hover:bg-teal-dark transition-colors"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
